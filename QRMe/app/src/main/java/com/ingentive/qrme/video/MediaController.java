package com.ingentive.qrme.video;
...
public class MediaController {
    ...
    @TargetApi(16)
    private long readAndWriteTrack(final MediaExtractor extractor, MP4Builder mediaMuxer, MediaCodec.BufferInfo info, long start, long end, File file, boolean isAudio) throws Exception {
...
//        int originalHeight = Integer.valueOf(height);
        ...
        cacheFile = new File(
                ...
                //  /storage/emulated/0/VideoCompressor/Compressed Videos/VIDEO_20160407_163815.mp4
        );
